package uz.bdmgroup.barakasavdo.services
...
import uz.bdmgroup.barakasavdo.BuildConfig
import uz.bdmgroup.barakasavdo.R
import uz.bdmgroup.barakasavdo.Utils.PrefUtils
import uz.bdmgroup.barakasavdo.screen.MainActivity
    ...
    fun showMessage(title: String, body: String, id: Long = System.currentTimeMillis()){
        ...
        val builder =
            NotificationCompat.Builder(this, channelId)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(applicationContext.resources, R.drawable.iconka))
